...
public class wafom_64 {
    ...
    public wafom_64 (DigitalNetBase2 dn, double c, int s,int w,int k) {
        this.dn=dn;
        this.c=c;
        this.s=s;
        this.w=w;
