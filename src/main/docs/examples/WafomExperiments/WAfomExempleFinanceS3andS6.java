...
public class WAfomExempleFinanceS3andS6 {
	...
	public WAfomExempleFinanceS3andS6(AsianOption asian) {
		this.asian = asian;
	}
	...
	public static void main(String[] args) {
		...
		WAfomExempleFinanceS3andS6 test = new WAfomExempleFinanceS3andS6(asian);
